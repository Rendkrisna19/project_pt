...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  const tbody=$('#tbody-data'); const selU=$('#filter-unit'), selB=$('#filter-bulan'), selT=$('#filter-tahun');
  ...
  document.body.addEventListener('click',e=>{
    if(e.target.classList.contains('btn-edit')){
      ...
      const form=document.getElementById('crud-form'); form.reset(); document.getElementById('form-action').value='update'; document.getElementById('form-id').value=d.id;
      Object.entries(d).forEach(([k,v])=>{const el=document.getElementById(k); if(el) el.value=v??'';}); open();
    }

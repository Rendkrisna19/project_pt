...
try {
  ...
  $stmt = $conn->query("
    SELECT b.*,
           ...
           CASE WHEN b.rencana_bi = 0 THEN NULL ELSE ((b.realisasi_bi / b.rencana_bi) - 1) * 100 END AS diff_pct
    FROM lm_biaya b
  ...
  <div class="bg-white p-6 rounded-xl shadow-md overflow-x-auto">
    <table class="min-w-full text-sm">
      ...
      <tbody class="text-gray-800">
        <?php if (!$rows): ?>
          <tr><td colspan="10" class="text-center py-6 text-gray-500">Belum ada data.</td></tr>
...
// Export Excel & PDF (sertakan CSRF)

  ...
  <div class="space-y-6">
    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          <label class="block text-[11px] md:text-xs font-bold text-gray-500 uppercase mb-1">Nama Barang</label>
    ...
    <div class="sticky-container">
        <table class="rekap">
          ...
          <tbody id="tbody-stok" class="text-gray-800">
            <tr><td colspan="<?= $canAction ? 10 : 9 ?>" class="text-center py-10 text-gray-500"><i class="ti ti-loader animate-spin text-xl mb-2 inline-block"></i><br>Memuat data...</td></tr>
          </tbody>
        </table>
    </div>
  ...
  <div id="crud-modal" class="fixed inset-0 bg-black/60 z-[60] hidden items-center justify-center p-3 sm:p-4 backdrop-blur-sm transition-opacity">
    <div class="bg-white p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-3xl flex flex-col max-h-[95vh] sm:max-h-[90vh]">
      ...
      <div class="flex items-center justify-between mb-4 sm:mb-6 border-b pb-3 sm:pb-4 shrink-0">
        <h3 id="modal-title" class="text-lg sm:text-xl font-bold text-gray-800">Input Stok Barang Gudang</h3>
      ...
      <form id="crud-form" novalidate class="overflow-y-auto pr-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
          <div class="md:col-span-1">
            ...
            <select name="kebun_id" id="kebun_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 outline-none" required>
          ...
          <div class="md:col-span-2">
            <label class="block text-[11px] sm:text-xs font-bold text-gray-600 uppercase mb-1">Nama Barang</label>
            <select name="jenis_barang_id" id="jenis_barang_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 outline-none" required>
          ...
          <div class="grid grid-cols-2 md:grid-cols-2 gap-3 md:col-span-3">
            <div>
              <label class="block text-[11px] sm:text-xs font-bold text-gray-600 uppercase mb-1">Bulan</label>
              <select name="bulan" id="bulan" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 outline-none" required>
            ...
            <div>
              ...
              <select name="tahun" id="tahun" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-cyan-500 outline-none" required>
          ...
          <div>
            ...
            <input type="number" step="0.01" name="stok_awal" id="stok_awal" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm calc-trigger focus:ring-2 focus:ring-cyan-500 outline-none" min="0" value="0">
          </div>
          <div>
            <label class="block text-[11px] sm:text-xs font-bold text-gray-600 uppercase mb-1">Mutasi Masuk</label>
            <input type="number" step="0.01" name="mutasi_masuk" id="mutasi_masuk" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm calc-trigger focus:ring-2 focus:ring-cyan-500 outline-none" min="0" value="0">
          </div>
          <div>
            <label class="block text-[11px] sm:text-xs font-bold text-gray-600 uppercase mb-1">Mutasi Keluar</label>
            <input type="number" step="0.01" name="mutasi_keluar" id="mutasi_keluar" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm calc-trigger focus:ring-2 focus:ring-cyan-500 outline-none" min="0" value="0">
          </div>
          <div>
            <label class="block text-[11px] sm:text-xs font-bold text-gray-600 uppercase mb-1">Pasokan</label>
            <input type="number" step="0.01" name="pasokan" id="pasokan" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm calc-trigger focus:ring-2 focus:ring-cyan-500 outline-none" min="0" value="0">
          </div>
          <div>
            <label class="block text-[11px] sm:text-xs font-bold text-gray-600 uppercase mb-1">Dipakai</label>
            <input type="number" step="0.01" name="dipakai" id="dipakai" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm calc-trigger focus:ring-2 focus:ring-cyan-500 outline-none" min="0" value="0">
          </div>

          <div class="md:col-span-1 border-t border-gray-100 pt-2 sm:pt-0 sm:border-t-0">
              <label class="block text-[11px] sm:text-xs font-bold text-cyan-600 uppercase mb-1">SISA (Otomatis)</label>
              <input type="text" id="inp_sisa" class="w-full bg-cyan-50 text-cyan-800 font-bold border border-cyan-200 rounded-lg px-3 py-2 text-sm text-right outline-none" readonly value="0.00">
          </div>
        </div>

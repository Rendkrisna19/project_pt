<?php
// admin/pemupukan_organik.php (FULL MODIF: pakai units, bukan teks afdeling)
session_start();
...
<div class="space-y-6">
  ...
  <div class="bg-white p-6 rounded-xl shadow-md">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
      ...
      <a href="cetak/pemupukan_organik_excel.php?tab=<?= $tab ?>" class="bg-green-600 text-white px-3 py-2 rounded">Export Excel</a>
<a href="cetak/pemupukan_organik_pdf.php?tab=<?= $tab ?>" class="bg-red-600 text-white px-3 py-2 rounded">Export PDF</a>

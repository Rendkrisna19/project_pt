...
<style>
    ...
    .sheet-scroll {
        flex: 1;
        overflow: auto;
        /* Scrollbar otomatis muncul disini */
        position: relative;
        width: 100%;
    }
    ...
    table.sheet {
        ...
        /* Wajib separate agar sticky border render benar */
        border-spacing: 0;
        font-size: 11px;
        font-family: 'Poppins', sans-serif;
        min-width: 100%;
    ...
    .sticky-top-1 th {
        ...
        top: 0;
        z-index: 40;
        /* Z-index tinggi agar di atas konten */
        background: var(--main);
        color: white;
        height: 40px;
    ...
    .sticky-top-1 .sticky-col {
        z-index: 50;
    }

    .sticky-top-2 .sticky-col {
        z-index: 49;
        background: #f8fafc;
    }
...
<div class="space-y-4 p-2 pb-2">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center bg-white p-4 rounded-xl border border-slate-200 shadow-sm gap-4">
        <div class="w-full md:w-auto">
            <a href="pilih_unit.php" class="text-base font-bold text-slate-400 hover:text-cyan-600 mb-2 flex items-center gap-2 transition">
                <i class="ti ti-arrow-left text-xl"></i> Kembali ke Unit
            </a>
...
<script>
    ...
    async function loadSheet() {
        ...
        try {
            const res = await fetch('kertas_kerja_crud.php', {
                method: 'POST',
                body: fd
            });

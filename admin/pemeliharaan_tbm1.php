...
$JENIS_ROWS = $conn->query("SELECT id, nama FROM md_pemeliharaan_tbm1 ORDER BY nama")->fetchAll(PDO::FETCH_ASSOC);
  ...
  <div class="bg-white rounded-xl shadow freeze-parent">
    <div class="px-3 py-2 border-b flex items-center gap-3">
      <div class="font-semibold text-gray-700 flex-1">
        Rekap TBM I • Tahun <?= htmlspecialchars($f_tahun) ?> <?= $f_afd ? "• $f_afd" : '' ?>
      </div>
      <?php if(!$isStaf): ?>

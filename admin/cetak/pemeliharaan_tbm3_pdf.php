...
$stmt = $conn->prepare("SELECT * FROM pemeliharaan_tbm3 $where ORDER BY jenis_nama ASC, unit_kode ASC");
$stmt->execute($params);
...
<html>
<head>
    <title>Laporan Pemeliharaan TBM III</title>
    <style>
...
<body>
    <div class="header-box">
        <h2>REKAPITULASI PEMELIHARAAN TBM III - TAHUN <?= $f_tahun ?></h2>

...
$sql = "SELECT * FROM pemeliharaan_tu $where ORDER BY jenis_nama ASC, unit_kode ASC";
...
// Header Info
$sheet->setCellValue('A1', 'REKAPITULASI PEMELIHARAAN TU');
...
header('Content-Disposition: attachment;filename="Laporan_TU_'.date('YmdHis').'.xlsx"');

...
$sql = "SELECT * FROM pemeliharaan_tm $where ORDER BY jenis_nama ASC, unit_kode ASC";
...
header('Content-Disposition: attachment;filename="Laporan_TM_'.date('YmdHis').'.xlsx"');

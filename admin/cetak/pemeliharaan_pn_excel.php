<?php
// pages/cetak/pemeliharaan_pn_excel.php
...
$sheet->setTitle('Rekap PN ' . $f_tahun);
...
$sheet->setCellValue('A1', 'REKAPITULASI PEMELIHARAAN PN TAHUN ' . $f_tahun);
...
foreach ($rows as $r) {
    ...
    // Tulis Cell (Gunakan kolom langsung dari tabel pemeliharaan_pn)
    ...
    $sheet->setCellValue('E' . $row, $r['hk']); // Kolom 'hk'
    ...
    // Styling Conditional (Warna Merah/Hijau utk Delta)
...
// --- OUTPUT ---
$filename = 'Rekap_PN_' . $f_tahun . '.xlsx';

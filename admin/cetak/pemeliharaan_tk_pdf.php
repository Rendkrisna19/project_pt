...
$stmt = $conn->prepare("SELECT * FROM pemeliharaan_tk $where ORDER BY jenis_nama ASC, unit_kode ASC");
$stmt->execute($params);
...
<html>
<head>
    <title>Laporan Pemeliharaan TK</title>
    <style>
...
<body>
    <div class="header-box">
        <h2>REKAPITULASI PEMELIHARAAN TK - TAHUN <?= $f_tahun ?></h2>

...
$sql = "SELECT * FROM pemeliharaan_tbm3 $where ORDER BY jenis_nama ASC, unit_kode ASC";
...
$sheet->setTitle('Rekap TBM III');

// Header Info
$sheet->setCellValue('A1', 'REKAPITULASI PEMELIHARAAN TBM II');
...
header('Content-Disposition: attachment;filename="Laporan_TBM III_'.date('YmdHis').'.xlsx"');

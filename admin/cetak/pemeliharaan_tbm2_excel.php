...
$sql = "SELECT * FROM pemeliharaan_tbm2 $where ORDER BY jenis_nama ASC, unit_kode ASC";
...
header('Content-Disposition: attachment;filename="Laporan_TBM II_'.date('YmdHis').'.xlsx"');

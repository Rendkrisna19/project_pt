...
$stmt = $conn->prepare("SELECT * FROM pemeliharaan_tbm1 $where ORDER BY jenis_nama ASC, unit_kode ASC");
$stmt->execute($params);
...
<html>
<head>
    <title>Laporan Pemeliharaan TBM I</title>
    <style>
...
<body>
    <div class="header-box">
        <h2>REKAPITULASI PEMELIHARAAN TBM I - TAHUN <?= $f_tahun ?></h2>

...
$sql = "SELECT * FROM pemeliharaan_tk $where ORDER BY jenis_nama ASC, unit_kode ASC";
...
// Header Info
$sheet->setCellValue('A1', 'REKAPITULASI PEMELIHARAAN TK');
...
header('Content-Disposition: attachment;filename="Laporan_TK_'.date('YmdHis').'.xlsx"');

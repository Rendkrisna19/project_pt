...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="relative z-10 flex flex-col h-full">
        ...
        <nav class="flex-1 px-3 space-y-1 overflow-y-auto custom-scrollbar pb-6">
            ...
            <a href="peta_rekap_pilih_unit.php" class="flex items-center px-4 py-3 text-sm rounded-r-lg group hover:text-violet-300 <?= navClass('peta_rekap', $currentPage) ?>">
                <i data-lucide="layers" class="w-5 h-5 mr-3 group-hover:text-violet-400 transition-colors <?= $currentPage=='peta_rekap'?'text-white':'' ?>"></i>
                <span>Peta Rekap</span>
            </a>

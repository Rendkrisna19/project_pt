...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="relative z-10 flex flex-col h-full">
        ...
        <nav class="flex-1 px-3 space-y-1 overflow-y-auto custom-scrollbar pb-6">
            ...
            <div class="px-4 mt-6 mb-2 flex items-center gap-2">
                <span class="text-[10px] font-bold text-cyan-600/70 uppercase tracking-widest">PETA</span>
                <div class="h-px bg-cyan-900/30 flex-1"></div>
            </div>
            ...
            <a href="pemetaan_pilih_unit.php" class="flex items-center px-4 py-3 text-sm rounded-r-lg group hover:text-emerald-300 <?= navClass('pemetaan', $currentPage) ?>">
                ...
                <span>MCS Harian</span>
            </a>

            <a href="peta_rekap_pilih_unit.php" class="flex items-center px-4 py-3 text-sm rounded-r-lg group hover:text-cyan-300 <?= navClass('peta_rekap', $currentPage) ?>">
                <i data-lucide="layers" class="w-5 h-5 mr-3 group-hover:text-cyan-400 transition-colors <?= $currentPage=='peta_rekap'?'text-white':'' ?>"></i>
                <span>MCS Bulanan</span>
            </a>
